...
Effect standard_floppy_building
{
	VertexShader = "VS_floppy_mesh"
	PixelShader = "PS_standard"
	Defines = { "ATLAS" "ENABLE_SNOW" "GRADIENT_BORDERS" "CITY_GRADIENT" "TERRAIN" "PDX_MESH_SNAP_MESH_TO_TERRAIN" }
}
Effect standard_floppy_buildingShadow
{
	VertexShader = "VS_floppy_mesh_shadow"
	PixelShader = "PixelPdxMeshStandardShadow"
	RasterizerState = ShadowRasterizerState
	Defines = { "TERRAIN" "PDX_MESH_SNAP_MESH_TO_TERRAIN" }
}

# --- Buildings under construction (floppy) ---

Effect standard_floppy_in_construction_building1
{
	VertexShader = "VS_floppy_mesh"
	PixelShader = "PS_standard"
	Defines = { "ENABLE_SNOW" "GRADIENT_BORDERS" "CITY_GRADIENT" "TERRAIN" "PDX_MESH_SNAP_MESH_TO_TERRAIN"
		"CONSTRUCTION_PREVENTION_MAX 0.075"
		"CONSTRUCTION_PREVENTION_MIN 0.0"
		"CONSTRUCTION_PREVENTION_MULT 1.00"
	}
}
Effect standard_floppy_in_construction_building1Shadow
{
	VertexShader = "VS_floppy_mesh_shadow"
	PixelShader = "PixelPdxMeshStandardShadow"
	RasterizerState = ShadowRasterizerState
...
Effect standard_floppy_in_construction_building2
{
	VertexShader = "VS_floppy_mesh"
	PixelShader = "PS_standard"
	Defines = { "ENABLE_SNOW" "GRADIENT_BORDERS" "CITY_GRADIENT" "TERRAIN" "PDX_MESH_SNAP_MESH_TO_TERRAIN"
		"CONSTRUCTION_PREVENTION_MAX 0.0"
		"CONSTRUCTION_PREVENTION_MIN 0.075"
		"CONSTRUCTION_PREVENTION_MULT 1.00"
	}
}
Effect standard_floppy_in_construction_building2Shadow
{
	VertexShader = "VS_floppy_mesh_shadow"
	PixelShader = "PixelPdxMeshStandardShadow"
	RasterizerState = ShadowRasterizerState
...
Effect standard_floppy_in_construction_building3
{
	VertexShader = "VS_floppy_mesh"
	PixelShader = "PS_standard"
	Defines = { "ATLAS" "ENABLE_SNOW" "GRADIENT_BORDERS" "CITY_GRADIENT" "TERRAIN" "PDX_MESH_SNAP_MESH_TO_TERRAIN"
...
Effect standard_floppy_in_construction_building3Shadow
{
	VertexShader = "VS_floppy_mesh_shadow"
	PixelShader = "PixelPdxMeshStandardShadow"
	RasterizerState = ShadowRasterizerState
...
# --- Buildings under construction (standard) ---

Effect standard_building_in_construction1
{
	VertexShader = "VS_standard"
	PixelShader = "PS_standard"
	Defines = { "ENABLE_SNOW" "GRADIENT_BORDERS" "CITY_GRADIENT" "TERRAIN"
...
Effect standard_building_in_construction1Shadow
{
	VertexShader = "VS_standard_shadow"
	PixelShader = "PixelPdxMeshStandardShadow"
	RasterizerState = ShadowRasterizerState
...
Effect standard_building_in_construction2
{
	VertexShader = "VS_standard"
	PixelShader = "PS_standard"
	Defines = { "ENABLE_SNOW" "GRADIENT_BORDERS" "CITY_GRADIENT" "TERRAIN"
...
Effect standard_building_in_construction2Shadow
{
	VertexShader = "VS_standard_shadow"
	PixelShader = "PixelPdxMeshStandardShadow"
	RasterizerState = ShadowRasterizerState
...
Effect standard_building_in_construction3
{
	VertexShader = "VS_standard"
	PixelShader = "PS_standard"
	Defines = { "ENABLE_SNOW" "GRADIENT_BORDERS" "CITY_GRADIENT" "TERRAIN"
...
Effect standard_building_in_construction3Shadow
{
	VertexShader = "VS_standard_shadow"
	PixelShader = "PixelPdxMeshStandardShadow"
	RasterizerState = ShadowRasterizerState
...
Effect atlas_political_fixShadow
{
	VertexShader = "VS_standard_shadow"
	PixelShader = "PixelPdxMeshStandardShadow"
	Defines = { "TERRAIN" }
...
Effect atlas_political_fix_city_gradient
{
	VertexShader = "VS_standard"
	PixelShader = "PS_standard"
	Defines = { "ATLAS" "ENABLE_SNOW" "GRADIENT_BORDERS" "TERRAIN" "CITY_GRADIENT" }
}
Effect atlas_political_fix_city_gradientShadow
{
	VertexShader = "VS_standard_shadow"
	PixelShader = "PixelPdxMeshStandardShadow"
	Defines = { "TERRAIN" }
...
Effect atlas_political_fix_two_sided
{
	VertexShader = "VS_standard"
	PixelShader = "PS_standard"
	Defines = { "ATLAS" "ENABLE_SNOW" "GRADIENT_BORDERS" "TERRAIN" }
...
Effect atlas_political_fix_two_sidedShadow
{
	VertexShader = "VS_standard_shadow"
	PixelShader = "PixelPdxMeshStandardShadow"
	Defines = { "TERRAIN" }
...
Effect atlas_political_fix_city_gradient_two_sided
{
	VertexShader = "VS_standard"
	PixelShader = "PS_standard"
	Defines = { "ATLAS" "ENABLE_SNOW" "GRADIENT_BORDERS" "TERRAIN" "CITY_GRADIENT" }
...
Effect atlas_political_fix_city_gradient_two_sidedShadow
{
	VertexShader = "VS_standard_shadow"
	PixelShader = "PixelPdxMeshStandardShadow"
	Defines = { "TERRAIN" }
...
Effect ship_flag_show_in_papermap
{
	...
	Defines = { "SHIP" "FLAG" "UNIT_BUFFERS" "SHOW_IN_PAPERMAP" "TERRAIN"
		"LIGHT_INTENSITY_FACTOR 0.1"
		"CUBEMAP_INTENSITY_FACTOR 1"
		"ROUGHTNESS_FACTOR 0.5" 
		"RIM_INTENSITY_FACTOR 5"}
